...
def generateimage():
    try:
        ...
        predictions_image_link = models.model(dataset=dataset)
        new_predictions_image_link = "http://localhost:8501/uploads/"+predictions_image_link

        response_obj = {
            "predictions_dataset": "predictions_dataset",
            "image_url": [new_predictions_image_link, new_predictions_image_link, new_predictions_image_link],
